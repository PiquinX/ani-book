...
export default function EditSerieForm({ id, title, poster, rate, description, onSuccess }: SerieUpdateType & { onSuccess?: () => void }) {
      ...
      <form className='flex flex-col gap-5' action={dispatch}>
        <div className='flex px-10 py-5 bar flex-col gap-5'>
          ...
          <div className='w-full h-max'>
            ...
            />
            <FormErrorMessage id='serie-description-error' errors={state?.errors?.description} />
          </div>
