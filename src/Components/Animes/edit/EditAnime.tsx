...
const EditAnime = ({ anime }: { anime: AnimeType }) => {
  ...
  return (
    ...
    >
      <div
        className='rounded-lg animate-appear-fast border border-noir-blue shadow-[0_0_25px_5px_rgba(0,0,255,0.6)] bg-[#000000] opacity-100 w-full md:w-152 lg:w-3xl h-full sm:h-[90%] duration-150 py-5 flex flex-col items-center justify-center relative'
      >
        <Link
          scroll={false}
