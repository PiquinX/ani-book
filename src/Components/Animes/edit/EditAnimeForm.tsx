...
export default function EditAnimeForm({ id, title, poster, rate, description, isFinished, onSuccess }: AnimeUpdateType & { onSuccess?: () => void }) {
      ...
      <form className='flex overflow-hidden flex-col gap-5' action={dispatch}>
        <div className='flex px-4 xs:px-6 sm:px-10 py-5 bar h-full overflow-hidden overflow-y-scroll flex-col gap-5'>
          ...
          <div className='flex gap-2 flex-col'>
            ...
            />
            <img className='rounded self-center w-full px-2' src={posterUrl} alt={`${title} poster`} />
